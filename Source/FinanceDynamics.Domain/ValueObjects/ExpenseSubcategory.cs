namespace FinanceDynamics.Domain.ValueObjects
{
    public sealed record ExpenseSubcategory : SubcategoryTransaction<ExpenseCategory>
    {
        ...
        public static readonly ExpenseSubcategory HealthPlan = new("Plano de Saúde", ExpenseCategory.Health);
        ...
        public static readonly ExpenseSubcategory AmazonPrimeVideo = new("Amazon Prime Video", ExpenseCategory.Streaming);
        public static readonly ExpenseSubcategory AppleTV = new("Apple TV", ExpenseCategory.Streaming);
        public static readonly ExpenseSubcategory DisneyPlus = new("Disney Plus", ExpenseCategory.Streaming);
        public static readonly ExpenseSubcategory HBOMAX = new("HBO MAX", ExpenseCategory.Streaming);
        public static readonly ExpenseSubcategory Netflix = new("Netflix", ExpenseCategory.Streaming);
        public static readonly ExpenseSubcategory Paramount = new("Paramount Plus", ExpenseCategory.Streaming);

        public static readonly ExpenseSubcategory INSS = new("INSS", ExpenseCategory.Taxes);
